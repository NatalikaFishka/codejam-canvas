...
let width2 = finalData2[0].length;
let height2 = finalData2.length;
let scaleX2 = canvas_32x32.width / width2;
let scaleY2 = canvas_32x32.height / height2;
...
for (let row = 0; row < height2; row++) {
    for (let col = 0; col < width2; col++) {
        ctx2.fillStyle = finalData2[row][col];
        ctx2.fillRect(col * scaleX2, row * scaleY2, scaleX2, scaleY2);
    }
}


const selectedButton = (el) => {
    for (let i = 0; i < el.length; i++) {
        el[i].addEventListener('click', function () {
            let selectedCanvas = el[i].value;
